package com.egaragul.pomodoro.component
...
class LoaderView @JvmOverloads constructor(
    ...
    init {
        if (attrs != null) {
            ...
            color = styledAttrs.getColor(R.styleable.LoaderView_custom_color, Color.RED)
            style = styledAttrs.getInt(R.styleable.LoaderView_custom_style, FILL)
            styledAttrs.recycle()
        }
